...
import SponsorRedBull from '@/assets/SponsorRedBull.png.png'
import SponsorForbes from '@/assets/SponsorForbes.png.png'
import SponsorFortunes from '@/assets/SponsorFortune.png.png'
  ...
  className='md:flex mx-auto w-5/6 items-center justify-center md:h-5/6 '>
    ...
    className='mt-8 flex items-center gap-8'>
      <ActionButton setSelectedPage={setSelectedPage}>
        ...
        <AnchorLink className='text-sm font-bold text-primary-500 underline hvoer:text-secondary-500
    ...
    <div>
        <img src={HomePageGraphic} className='flex basis-3/5 justify-center md:z-10 md:ml-40 md:mt-16 md:justify-items-end' alt="" />
    </div>
